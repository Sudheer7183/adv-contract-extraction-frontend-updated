  ...
  return (
    ...
    >
      <div className='text-center mb-10'>
        {/* begin::Title */}
        <h1 className='text-dark fw-bolder mb-3'>Request Set Password ?</h1>
        {/* end::Title */}

        {/* begin::Link */}
        <div className='text-gray-500 fw-semibold fs-6'>
          Enter your email to request your create password mail.
        </div>
        {/* end::Link */}
      </div>
      ...
      {hasErrors === false && (
        <div className='mb-10 bg-light-info p-8 rounded'>
          <div className='text-info'>Sent create password. Please check your email</div>
        </div>
      )}
      {/* end::Title */}
