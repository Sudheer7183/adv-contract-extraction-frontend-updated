...
function AssignReviewer() {
  const { selected, setSelected, setUpdate, setUserAssign, projectid } = useListView()
  ...
  console.log("assign reviewer projectid", projectid);
  ...
  useEffect(() => {
    ...
    request(`${BASEURL}graphql/`, Users, { projectId: projectid }, {Authorization: `Bearer ${localStorage.getItem('Token')}`}).then((user: any) => setUsers(user.reviewUserDetail.edges))
  }, []);
